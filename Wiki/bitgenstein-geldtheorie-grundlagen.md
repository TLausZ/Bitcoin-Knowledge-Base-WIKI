...
### Die semantische Theorie des Geldes

Farrington nennt seine Kritik pointiert "semantische Theorie": Geld ist, was als Geld dient — als Tauschmittel, Recheneinheit, Wert­speicher. Wer diese Funktionen nicht erfüllt, ist kein Geld. Wer noch kein Geld ist, hat keinen Wert. Wer keinen Wert hat, wird nie Geld. Quod erat demonstrandum. [[aprycot-bitgenstein-semantik-ergo-realitaet]]

Das Problem ist nicht die Definition selbst, sondern ihre Verwendung als abgeschlossene Wahrheit. Sie erklärt nicht, wie neues Geld entstehen kann, weil in ihr kein Raum für Entstehung ist — nur für Zustandsbeschreibung. Larry White hat ein anschauliches Beispiel: Als Ecuador 2000 den US-Dollar einführte, war der Dollar in Ecuador kein "Geld" im Sinne dieser Definition — er hatte dort keine Akzeptanz, keine Verwendungsgeschichte, kein Netzwerk. Dennoch setzte er sich durch, weil er Eigenschaften hatte, die die erzwungene Funktion des Sucre übertrafen. Die semantische Theorie hätte das im Voraus ausgeschlossen.

Das Spanische unterscheidet *ser* (unveränderliches Sein: "I am a woman") von *estar* (vorübergehender Zustand: "I am hungry"). Die semantische Geldtheorie behandelt Geld als *ser* — als ob es eine Wesenseigenschaft hätte, die entweder vorhanden ist oder nicht. Farrington argumentiert, dass Geld *estar* ist: ein Zustand, in den ein Gut eintreten und den es verlassen kann.

Das führt zum Startup-Vergleich: Ein Gründer, der 2010 Bitcoin als "Geld" beschrieben hätte, wäre nicht glaubwürdiger oder unglaubwürdiger als ein Gründer, der sagt, sein Produkt werde die Branche dominieren. Beide Aussagen betreffen zukünftige Zustände, keine gegenwärtigen Tatsachen. Die semantische Theorie legt die Beweislast einseitig auf die neue Seite und entlastet die bestehende vollständig.
...
Farrington beschreibt, was Beobachter sehen würden, wenn ein neues Geld entsteht: keine saubere Gleichung, sondern eine sich entwickelnde Erzählung. Extreme Volatilität, weil jede individuelle Entscheidung das Netzwerk beeinflusst, das die anderen Entscheidungen beeinflusst. Irrationalität, weil die Netzwerkdynamik die individuelle Rationalität übersteigt. Keine exponentielle Nutzerkurve wie ein soziales Netzwerk, weil die "Netzwerkeffekte" hier keinen Kommunikationskanal öffnen, sondern eine kollektive Unsicherheitsverarbeitung sind. [[aprycot-bitgenstein-semantik-ergo-realitaet]]

Die semantische Theorie würde das als Beweis für das Scheitern des neuen Geldes interpretieren. Ein genauerer Beobachter würde darin die erwartbare Erscheinung eines Prozesses sehen, der langfristig auf die Eigenschaften des Geldes konvergiert — nicht auf seinen aktuellen Gebrauch.
