...
Fortgeschrittene Setups (Multisig, Passphrase, Air-Gap) sind dann sinnvoll, wenn das Bedrohungsmodell es erfordert und man die Mechanismen vollständig versteht — einschliesslich aller Verlustrisiken.
