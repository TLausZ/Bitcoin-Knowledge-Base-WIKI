# Bitcoin Treasury Companies (Marktübersicht)
...
Snapshot vom 17. Juli 2026 (bitcointreasuries.net, BTC-Preis $64'105): 197 börsennotierte Unternehmen halten zusammen 1'263'286 BTC, rund $81 Mrd. oder 6.0% der maximalen 21 Millionen. Die Verteilung ist extrem kopflastig — Strategy (MSTR) hält mit 843'775 BTC allein zwei Drittel aller Public-Company-Bestände und 4.018% des gesamten Supplys. Die Top 100 decken mit 1'260'555 BTC praktisch den ganzen Sektor ab; der Long Tail unterhalb von Rang 50 hält meist unter 1'000 BTC. Zur Einordnung die übrigen Kategorien der Seite: ETFs und Börsen 1'622'533 BTC, Regierungen 649'963 BTC, Privatunternehmen 284'452 BTC. Der Snapshot dient als Zeitreihen-Anker; Strategie und Mechanik des Treasury-Modells stehen in [[bitcoin-unternehmens-strategie]].
...
Reine Treasury-Vehikel (Strategy, Twenty One Capital, Metaplanet, Smarter Web), Miner mit Bestandsaufbau (MARA, Riot, CleanSpark, Hut 8), Krypto-Finanzfirmen (Coinbase, Bullish, Galaxy, Gemini) und operative Konzerne mit Neben-Position (Tesla, SpaceX, Block, Nexon). Bei den Konzernen ist die Position relativ zur Bilanz winzig — bei Tesla und SpaceX 0.1% der Market Cap, bei den reinen Vehikeln dagegen oft ein Mehrfaches davon. Geografisch dominiert die USA; Japan (Metaplanet, Remixpoint, Nexon, Anap, Mac House) und ein verstreutes Europa (Bitcoin Group SE, Capital B, Smarter Web, H100, Aker) folgen mit Abstand.

### Einordnung

Public Companies sind mit 1.26M BTC die drittgrösste Halterkategorie hinter ETFs/Börsen (1.62M) und vor Regierungen (0.65M). Für die These der institutionellen Adoption ([[bitcoin-etf-und-institutionelle-verwahrung]], [[bitcoin-silent-ipo]]) ist der Befund zweischneidig: Die Bestände sind gross und stabil, aber die Bewertungen der Halter zeigen, dass der Markt das Geschäftsmodell «Bitcoin auf der Bilanz» derzeit mit Abschlag bepreist. Aus Selbstverwahrungs-Sicht konzentrieren diese Vehikel zudem Custody-Risiko ([[selbstverwahrung-und-boersenrisiken]]).
