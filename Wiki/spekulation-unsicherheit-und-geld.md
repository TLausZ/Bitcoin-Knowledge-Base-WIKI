...
Ludwig von Mises unterschied zwei Arten von Wahrscheinlichkeit: Klassenwahrscheinlichkeit (objektiv, kalkulierbar, versicherbar) und Fallwahrscheinlichkeit (subjektiv, einmalig, nicht versicherbar). Alle wirtschaftlichen Entscheidungen fallen in die zweite Kategorie. Daraus folgt: Jede Vermögensanlage ist spekulativ — nicht nur Bitcoin, sondern auch das Halten von US-Dollar. Die Frage ist nicht, ob man spekuliert, sondern womit und warum. Geld entsteht nach Hoppe als Absicherung gegen eben diese Unsicherheit.

## Body

### Alle Handlungen sind spekulativ

Mises schreibt in Human Action: Wenn jemand die Zukunft mit Gewissheit kennen würde, gäbe es kein wirtschaftliches Handeln — alles wäre bereits festgelegt. Weil die Zukunft unbekannt ist, muss jeder, der eine Entscheidung trifft, eine Vermutung über künftige Zustände der Welt anstellen. Das ist Spekulation im strengen Sinn: eine Wette auf eine noch nicht feststehende Realität. [[aprycot-jeder-ist-ein-spekulant]]

Das Halten von Bargeld ist eine Spekulation darauf, dass andere Menschen dieses Bargeld morgen noch akzeptieren. Das Investieren in Aktien ist eine Spekulation auf künftige Unternehmensgewinne. Das Kaufen einer Immobilie ist eine Spekulation auf künftige Mietnachfrage. Nichts davon ist sicher; alles davon ist strukturell identisch mit dem, was Kritiker an Bitcoin als "Spekulation" bemängeln.

### Zwei Arten von Wahrscheinlichkeit

Mises unterschied scharf zwischen zwei Konzepten, die im Alltag vermischt werden:

**Klassenwahrscheinlichkeit (objektive Wahrscheinlichkeit):** Gilt für Ereignisse, die zu einer bekannten Klasse wiederholbarer Ergebnisse gehören. Die Wahrscheinlichkeit, beim Münzwurf Kopf zu erhalten, ist 50% — berechenbar, stabil, unabhängig von Kontext. Solche Risiken sind versicherbar: Wenn man viele gleichartige Ereignisse zusammenfasst, mitteln sich Schwankungen heraus.
...
Angesichts der Fallwahrscheinlichkeit gibt es laut Mises drei grundlegende Reaktionsmuster:

**Glücksspiel:** Man setzt auf unbekannte Ergebnisse ohne tieferes Wissen oder Analyse, in der Erwartung eines Gewinns durch Zufall. Roulette, Lotterien.

**Technik:** Man nutzt bekanntes Wissen und beherrschbare Methoden, um Unsicherheit zu reduzieren. Ein Ingenieur berechnet Brückenbelastung mit bekannten physikalischen Gesetzen; der Restbereich der Unsicherheit wird durch Sicherheitsfaktoren abgedeckt.

**Spekulation:** Man versucht, künftige Entwicklungen besser einzuschätzen als andere Marktteilnehmer, und handelt entsprechend. Unternehmer, die eine Marktlücke erkennen, bevor andere sie sehen, spekulieren. Wer eine Währung kauft, weil er erwartet, dass andere sie weiterhin wertschätzen, spekuliert. [[aprycot-jeder-ist-ein-spekulant]]

Alle drei Reaktionen können gleichzeitig auftreten. Ein Unternehmer nutzt Technik in der Produktion, spekuliert auf die Nachfrage und riskiert dabei eigenes Kapital wie beim Glücksspiel — aber mit besserer Informationsgrundlage.
...
### USD und Bitcoin als gleichartig spekulative Assets

Wer USD hält, spekuliert darauf, dass:
- die US-Regierung die Kaufkraft nicht zu schnell erodiert
- andere Marktteilnehmer den Dollar weiterhin akzeptieren
- der politische Wille zur Schuldenrückzahlung erhalten bleibt
- kein Systemschock (Hyperinflation, Dollarentwertung) eintritt

Wer Bitcoin hält, spekuliert darauf, dass:
- die Community die Konsensregeln nicht in Richtung Inflation ändert
- andere Marktteilnehmer Bitcoin weiterhin als Zahlungsmittel akzeptieren
...
- Gibt es eine sinnvolle Unterscheidung zwischen "fundierter Spekulation" und "reiner Spekulation" im Sinne der Mises'schen Praxeologie?
- Wie verändert sich der Charakter von Bitcoin als spekulative Absicherung, wenn seine Volatilität über Jahrzehnte abnimmt?
- Kann man Klassenwahrscheinlichkeit auf aggregierte Portfolios anwenden (z.B. über viele Bitcoin-Halter hinweg), auch wenn das Einzelereignis Fallwahrscheinlichkeit ist?
