...
Wankum (TBN #34, Dezember 2025) stellt eine These auf, die selten formuliert wird: Die Qualität des Geldes prägt die Qualität dessen, was eine Gesellschaft baut. Hartes Geld belohnt Langzeitdenken, weil es Kaufkraft nicht bestraft. Fiat belohnt schnellen Ressourcenumsatz. Das Ergebnis ist in der gebauten Umwelt sichtbar.
...
Wankum beschreibt die Konsequenz: Moderne Architektur widersteht oft zeitlosen Proportionsprinzipien bewusst — als ästhetische Programmatik ("weniger ist mehr", Brutalismus, Postmoderne). Das kann man als künstlerische Entscheidung deuten. Man kann es aber auch als systemisches Signal lesen: Wenn das Geld kurzfristig denkt, denkt die Baukultur mit.

Die Mona Lisa wurde über viele Jahre gemalt. Die Pyramiden entstanden über Generationen. Moderne Wohnblöcke entstehen in Monaten. Das ist kein Zufall der Technik — Bagger und Krane gab es in bescheideneren Formen auch früher. Es ist ein Signal der Zeitpräferenz. [[The Connection Between Money and Building Culture]]

### Bitcoin als möglicher Impuls
