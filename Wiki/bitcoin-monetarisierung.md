...
Vijay Boyapati beschreibt in "The Bullish Case for Bitcoin" (2018) einen spieltheoretisch begründeten Prozess der Monetarisierung: Geldgüter durchlaufen historisch vier Phasen — Sammlerstück, Wertspeicher, Tauschmittel, Recheneinheit. Bitcoin befindet sich seiner Analyse nach zwischen der zweiten und dritten Phase. Das macht den Wert von Bitcoin nicht arbiträr, sondern aus der Geschichte des Geldes selbst ableitbar.

## Body

### Der Ursprung von Geld: Sammlerstücke als Proto-Geld

Tauschhandel scheitert an der doppelten Koinzidenz der Bedürfnisse — beide Tauschpartner müssen genau das haben wollen, was der andere anbietet. Frühe Menschen lösten das Problem durch Sammlerstücke: Muscheln, Tierzähne, Feuersteine. Nick Szabo argumentiert, dass das menschliche Verlangen nach Sammlerstücken dem *Homo sapiens* einen evolutionären Vorteil gegenüber dem Neandertaler gab — Handelsbeziehungen über feindliche Stammegrenzen hinweg waren plötzlich möglich.

Das entscheidende Merkmal eines Proto-Geldes: Es muss von anderen als wertvoll anerkannt werden, nicht wegen seines Gebrauchswerts, sondern wegen seiner erwarteten Tauschbarkeit. Das ist spieltheoretisch selbstverstärkend. Je mehr Menschen eine Sache als Geld akzeptieren, desto mehr werden es tun. Geldgüter sind keine Entdeckung, sondern eine Konvergenz. [[aprycot-das-bullische-argument-fuer-bitcoin]]

### Die vier Monetarisierungsphasen

Boyapati destilliert aus der Geldgeschichte vier Phasen:
...
Gold war Jahrtausende lang der dominante Wertspeicher. Bitcoin hat mehrere strukturelle Vorteile:

- **Verifizierbarkeit:** Gold-Echtheit zu prüfen erfordert Expertise und Ausrüstung. Bitcoin-Eigentumsnachweis ist kryptographisch und kostenlos prüfbar.
- **Teilbarkeit:** Gold lässt sich bis auf einen Punkt teilen, danach wird es unpraktisch. 1 Bitcoin = 100 Millionen Satoshis — beliebig teilbar.
- **Transportierbarkeit:** Physisches Gold zu bewegen kostet Geld und Zeit. Bitcoin ist überweisbar in Minuten ohne physischen Aufwand.
- **Nicht-konfiszierbar:** Bitcoin, das mit dem Private Key im eigenen Kopf gesichert ist, kann nicht wie Gold im Lager beschlagnahmt werden.
...
Der Übergang zu einer neuen Geldform ist spieltheoretisch instabil: Es ist rational, das Gut zu halten, wenn man erwartet, dass andere es auch halten werden — und das Gegenteil gilt genauso. Frühe Bitcoiner standen vor diesem Problem: Der Wert war annähernd null, weil noch niemand Bitcoin als Geld anerkannte.

Satoshis Lösung war, Bitcoin zuerst als Technologieprojekt zu vermarkten, nicht als Geld. Techniker, Kryptographen und Cypherpunks — Menschen, die den Code verstanden — wurden zu ersten Inhabern. Diese Gruppe signalisierte Glaubwürdigkeit an die nächste Gruppe; die spieltheoretische Koordination konnte beginnen.

Das erklärt auch, warum Bitcoin-Adoption nicht linear, sondern in Wellen verläuft: Jeder Preiszyklus zieht eine neue Kohorte an, die vorher nicht bereit war, sich mit Bitcoin zu beschäftigen.
...
Boyapati benennt drei reale Risiken:
...
### Das adversariale Netzwerk: Warum jeder ein "Scammer" ist

Michael Goldstein (Bitstein) hat 2014 eine spieltheoretische Perspektive auf die Monetarisierungsphase formuliert: In einem Netzwerk, das vor Hyperbitcoinisierung steht, versucht jeder Teilnehmer, seinen Bitcoin-Anteil zu maximieren. Händler überzeugen dich, Bitcoin für Waren auszugeben, die weniger wert sein werden als das, was du aufgegeben hast. Investitionsvehikel (Altcoins, Mining-Verträge) versprechen höhere Renditen als Halten — auf Kosten deines Bitcoin-Anteils. Skeptiker behaupten, Bitcoin sei wertlos — was ihr eigenes Interesse (günstigere Einstiegspreise) bedient. [[aprycot-jeder-ist-ein-scammer]]

Goldsteins Begriff "Scammer" ist dabei eine Heuristik, kein moralischer Vorwurf. Er beschreibt eine strukturelle Situation: Wer Bitcoin kennt und seinen zukünftigen Wert einschätzt, hat Anreize, andere dazu zu bringen, es auszugeben. "Scammer ist eine Heuristik, kein Vorwurf."
...
Der entscheidende Schritt ist das Verstehen, warum das Bitcoin-Angebot von 21 Millionen glaubwürdig ist. Das liegt nicht im Code — es liegt darin, dass ein globales Netzwerk rationaler Akteure in einem freiwilligen Opt-in-System nie kollektiv abstimmen würde, die eigene Währung zu entwerten. Dieses Vertrauen entsteht nicht über Nacht; es konsolidiert sich über Tausende von 10-Minuten-Zyklen, in denen das System funktioniert und die Anreize hält.

„Bitcoin existiert als Lösung für das Geldproblem, das globales QE darstellt." [[aprycot-parker-lewis-gradually-then-suddenly.md]]
