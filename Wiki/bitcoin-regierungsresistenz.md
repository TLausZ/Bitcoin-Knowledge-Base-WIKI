...
Alex Gladstein analysiert in einem Quillette-Artikel von 2021, warum Regierungen Bitcoin bislang nicht aufhalten konnten. Zwei Angriffsvektoren bestehen: technische Netzwerkangriffe und rechtliche Verbote. Beide sind an Bitcoins Architektur gescheitert. Der Blocksize-Krieg 2017 zeigte, dass weder Miner noch Konzerne die Konsensregeln ändern können — Zehntausende Full-Node-Betreiber entscheiden. Rechtliche Verbote (China 2017, Indien) trieben Nutzer in P2P-Märkte, ohne die Adoption zu stoppen.

## Body

### Warum Bitcoin bisher unbesiegt ist

Gladstein listet strukturelle Gründe: Mining, Infrastruktur und Märkte sind geografisch verteilt, operieren in konkurrierenden Rechtssystemen und werden oft von anonymen Akteuren betrieben. Anders als bei anderen Kryptowährungen gibt es keinen zentralen Angriffspunkt. Kein Satoshi Nakamoto mehr, keine Foundation, keine Risikokapitalgeber, kein Governance-Token, keine Büros. Die dezentrale Architektur macht gezielte Einschüchterung wirkungslos. [[aprycot-gladstein-koennen-regierungen-bitcoin-aufhalten]]
...
### Regulatorischer Angriff: Die 6102-Analogie

Executive Order 6102 (1933) zwang US-Bürger, Gold bei Behörden abzugeben. Die Bitcoin-Community bereitet sich auf ein analoges Szenario vor: Staaten könnten Bürgern ein Zeitfenster geben, Bitcoin zu deklarieren — bei Strafe für Nichtbefolgung.

Der entscheidende Unterschied zu 1933: Gold lagerte bei Banken und konnte dort beschlagnahmt werden. Eigenverwaltete Bitcoin existieren nur als Information im Kopf oder auf einem Stück Metall. Kein physischer Lagerpunkt, kein zentraler Custody-Dienst als Angriffsfläche. Das Mantra „Not your keys, not your coins" (Andreas Antonopoulos) — jährlich am 3. Januar im „Proof-of-Keys"-Tag gefeiert — adressiert genau dieses Risiko. [[aprycot-gladstein-koennen-regierungen-bitcoin-aufhalten]]

### Verbote schaffen P2P-Märkte
...
### Anreizstruktur gegen Angriff

Gladstein benennt einen Mechanismus, der Angriffe unattraktiv macht: Warum sollte eine Regierung Bitcoin angreifen, wenn sie mehr davon hat, wenn sie ihr Energiemonopol oder die Fähigkeit, Fiat-Geld zu drucken, nutzt, um Bitcoin zu kaufen? Die Architektur zwingt potenzielle Angreifer dazu, sich zu engagieren — und dabei das System zu stärken, statt es zu schwächen.

Die einzige theoretische Möglichkeit, Bitcoin zu stoppen: Es so gestalten, dass niemand mehr einen abwertungssicheren, zensurresistenten, erlaubnisfreien, grenzenlosen, nicht diskriminierenden Finanzwert will. Solange dieser Bedarf existiert, gibt es Hashrate.

### Das Verbot als letzter Zweifel (Parker Lewis)

Parker Lewis ergänzt eine psychologische Beobachtung: Wer argumentiert, Regierungen würden Bitcoin verbieten, hat damit implizit zugegeben, dass Bitcoin funktioniert. Das ist, wie Lewis schreibt, "die letzte Phase des Zweifels — direkt vor der Akzeptanz."

Das Argument folgt einer bedingten Logik: Wenn Bitcoin als Geld nicht funktioniert, braucht niemand es zu verbieten. Wenn es funktioniert, werden Regierungen es versuchen zu verbieten. Der Ankerpunkt des Arguments ist also die Anerkennung, dass Bitcoin als Geld funktioniert. Die eigentliche Frage ist dann: Könnte ein Verbot erfolgreich sein?
