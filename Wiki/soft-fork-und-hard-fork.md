...
**Chainsplit-Risiko:** Trotzdem möglich. Ohne eine Mehrheit der Rechenleistung auf der neuen Version können Nodes der alten Version grössere Blöcke ablehnen, was zu einem Chainsplit führt.

**Beispiele:** SegWit (2017), Taproot (2021)

### Hard Fork: Regeln entfernen

Eine Hard Fork lockert die Regeln — der Satz gültiger Blöcke wird grösser. Zuvor ungültige Blöcke werden durch die geänderte Regel gültig.
...
**Keine Vorwärtskompatibilität:** Nodes der alten Version lehnen neue (z.B. grössere) Blöcke ab. Nodes der neuen Version akzeptieren alte Blöcke weiterhin.
...
Bei einem Hard Fork entstehen zwei parallele Chains. Zwei technische Schutzmassnahmen sind nötig:
