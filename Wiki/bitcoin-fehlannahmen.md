...
Die Basis-Blockchain hat festgelegte Kapazität — ca. 7 Transaktionen pro Sekunde, vergleichbar mit Fedwire (6/s), dem Settlement-Netzwerk des US-Dollar-Systems. Bitcoin ist als Settlement-Schicht konzipiert, nicht als Endnutzer-Zahlungssystem. Auf der zweiten Schicht ermöglicht das Lightning-Netzwerk Sofortzahlungen in Sekundenschnelle zu minimalen Kosten. Visa und Mastercard verlangen Händlern >2 % Gebühren; Lightning-Zahlungen sind nahezu kostenlos.

### "Bitcoin hat keinen inneren Wert"

Das Konzept des "inneren Werts" basiert auf Cashflow-Diskontierung — sinnvoll für Unternehmen und Anleihen, aber schon für Gold nicht anwendbar. Goldnachfrage durch industrielle Nutzung ist vernachlässigbar. Der Wert von Gold und Bitcoin entsteht daraus, dass Menschen sie als Wertaufbewahrungsmittel betrachten, das keine zentrale Entität kontrollieren kann. Wie die Realität zeigt: beide Assets werden als wertvoll erachtet. Ein Gut ist so viel wert, wie ihm beigemessen wird — und Millionen Menschen messen Bitcoin Wert bei.
...
Bitcoin kann technisch nicht verboten werden — das Netzwerk ist global verteilt und nicht zentral abschaltbar. Besitzverbote wären schwer durchzusetzen und würden Kapitalflucht in andere Jurisdiktionen auslösen. In Nigeria und China, die Handel stark einschränkten, ist Bitcoin trotzdem weit verbreitet. Inzwischen vergeben immer mehr Jurisdiktionen Bitcoin Legitimität durch ETF-Zulassungen. Die USA haben eine strategische Bitcoin-Reserve aufgebaut.

### "Es ist zu spät einzusteigen"

Dieselbe Aussage wurde nach jedem Halving und jedem Allzeithoch gemacht. Bitcoin-Halter von 2010–2013 sagten 2017 "zu spät". Bitcoin-Halter von 2017 sagten 2021 "zu spät". Bitcoin macht heute noch ~0,13 % des weltweiten Vermögens aus. Sollte es sich als überlegener Wertspeicher gegenüber Gold etablieren, wäre das allein eine Verfünffachung. Die Frage ist nicht, ob der Kurs schon hoch ist, sondern wo er in 10–20 Jahren stehen könnte.
...
- Wie verändert sich das Fehlannahmen-Landschaft mit steigender institutioneller Adoption?
