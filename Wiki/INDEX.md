...
Alle Artikel alphabetisch. Stand: 2026-07-18 (Compile-Pass 94: 1 neues File (Bitcoin Finance Report Q2/2026, Saile/Tröster, PDF 32 S.); +1 Artikel [bitcoin-beratung-und-micar] (MiCAR-Stichtag 1.7.2026, 118 CASPs, Beratungslücke 24/202, sechs DACH-Beratungs-CASPs, Art. 60/79/81, DIS/Volksbank-Praxis); [bitcoin-haltefrist-und-steuern] stark ausgebaut und auf established promoted (Klingbeil/Haushaltseckwerte 2027, Verfassungsrecht/Folgerichtigkeit, Blockpit-Datenkritik, Österreich 34 Mio. 2024, DAC8); ergänzt: [bitcoin-etf-und-institutionelle-verwahrung] (ETP vs. Wallet, Re-Intermediation, Morgan-Stanley-ETF), [stablecoins-und-agentische-zahlungen] (Visa/Mastercard/Stripe-Konsortium, BVNK, AllUnity EURAU/CHFAU, Qivalis), [blocksize-war] (Rückkehr der Debatte 2026), [bitcoin-als-strategische-reserve] (Hormus jetzt 2 Quellen), [bitcoin-unternehmens-strategie] (Strategy verkauft erstmals 32 BTC). Compile-Pass 93: 2 neue Files (bitcointreasuries-Snapshot 18.07. als .md + .csv, automatisierter __data.json-Abzug); [bitcoin-treasury-companies] um Zeitreihen-Abschnitt ergänzt (Tagesdelta 17.→18.07.: Top-100-Bestand flach, 197→209 Firmen); keine neuen Artikel. Article-Drafting, kein Pass: +1 Artikel [mvrv-und-realized-cap] (Mahmudov/Puell 2018 + Wüstenfeld-Dashboard-Methodik); Sigma-Bänder/HMM-Abschnitt in [bitcoin-powerlaw-und-preismodelle] ergänzt; 2 neue RAW-Digests. Compile-Pass 92: +1 Artikel [bitcoin-treasury-companies] aus bitcointreasuries.net-Snapshot (Top 100 Public Companies, alle Kennzahlspalten, eingeloggt); Related-Verlinkung in 13 Bestandsartikeln; mNAV/Cost-Basis-Daten in [bitcoin-unternehmens-strategie] eingewoben. Pass 91: LNMS-Import Etappe 4/4 (Abschluss) — 15 Paid-Hausanalysen + Interviews Dez 2025 – Jul 2026 (Hügli) verarbeitet; Hub [bitcoin-marktkommentar-lnms] finalisiert (Status established, 2026-Sektion: Realzinsen-Fokus, selbstkritischer Bärenmarkt-Ton); eingewoben in [globale-liquiditaet-und-finanzplumbing] (Realzinsen/US-Exceptionalism/Yen/Flaggschiff-Ausblick), [bitcoin-unternehmens-strategie] (DAT-Derisking + Edwards' Strategy-Dilemma) und [bitcoin-und-quantenrisiko] (Quanten-Overhang als Kapitalbremse). Gesamt: 106 LNMS-Quellen in 4 Etappen, 1 neuer Artikel. Pass 90: LNMS-Import Etappe 3/4 — 40 EN-Interviews Mai–Nov 2025 (Hügli) verarbeitet; neuer Artikel [globale-liquiditaet-und-finanzplumbing] (Liquiditäts-Cluster: Howell/Gromen/Kizemchuk/Consorti/Lighthouse/Infranomics); Hub [bitcoin-marktkommentar-lnms] um Verdichtung ab Mai 2025 erweitert; eingewoben in [stablecoins-und-agentische-zahlungen] (Ardoino/Gurbacs/GENIUS Act) und [bitcoin-und-quantenrisiko] (Edwards' aggressive Zeitschätzung). Pass 89: LNMS-Import Etappe 2/4 — 44 EN-Interviews H2/2024–Apr 2025 (Hügli) verarbeitet; Hub [bitcoin-marktkommentar-lnms] um Interview-Synthese erweitert; eingewoben in [makro-zinskurve-fed-und-rezession] (Liquiditäts-Gäste: Alden/Howell/Coutts/Consorti), [bitcoin-als-strategische-reserve] (SBR-Diskurs: Hougan/Pines/Thorn/Hendrickson), [bitcoin-unternehmens-strategie] (Treasury-Trade: Byworth/Van Straten/Peck/Cole), [bitcoin-besicherte-kredite] (Ledn/Battery/Abra/Lava). Pass 88: LNMS-Import Etappe 1/4 — Hub [bitcoin-marktkommentar-lnms] angelegt aus 7 Insight-DeFi/LNMS-Quellen 2024 (Hügli); LTH-Euphoriephase in [onchain-indikatoren-und-anlegerverhalten] und GBTC-Post-Launch-Dynamik in [bitcoin-etf-und-institutionelle-verwahrung] eingewoben. Pass 87: 2 neue Glossar-Quellen (bitcoin.org, developer.bitcoin.org) verarbeitet; 11 neue Begriffe in [glossar-bitcoin-technik] (u. a. 51%-Attacke, Hashrate, TXID, Change Address, Mainnet/Testnet, UASF/MASF, Weight Units/vByte, Merge Avoidance); keine neuen Artikel. Pass 86: +3 Glossar-Artikel [glossar-allgemein], [glossar-bitcoin-technik], [glossar-lightning] aus 6 Glossar-Quellen (House of Satoshi, aantonop, Mastering Bitcoin, Bitcoin Design, Lightning Labs, lnbook); Ethereum-Begriffe verworfen, neue Visualizer-Kategorie «glossar». Pass 85: +2 Buch-Artikel [einfuehrung-in-das-lightning-netzwerk] (Tier C, dt. «Mastering the Lightning Network»), [magic-future-money] (Tier A, SciFi-Anthologie Brenneis); `buecher` jetzt 25. Pass 84: +3 Buch-Artikel [das-kleine-bitcoin-buch], [das-trojanische-pferd-der-freiheit], [hidden-repression_…] (Gladstein-Cluster); Artikel [21-lektionen] entfernt; `buecher` damals 23. Pass 82: +11 Buch-Artikel für Visualizer-Kategorie «buecher» — Svanholm-Sammelartikel gesplittet, IoM 1–3, Menger, Steiner, Privacy Handbuch, Grokking/Bitcoin begreifen, Mastering Bitcoin; `buecher` damals 14. Pass 79: +1 neuer Artikel [satoshi-zitate] aus Satoshi Nakamoto Institute «The Quotable Satoshi»; Schlüsselzitate in 5 Fachartikel eingewoben. Pass 78: +1 neuer Artikel [crypto-adaption-europa-bsd-2026] aus Boerse-Stuttgart-Digital-Marktstudie. Pass 77: Wüstenfelds BBR-Newsletter (23 Ausgaben) + Hub [bitcoin-akademische-forschung-bbr]. Pass 76: englisches Wüstenfeld-Archiv. Pass 74: +2 Artikel [makro-zinskurve-fed-und-rezession], [onchain-indikatoren-und-anlegerverhalten])

| Artikel | Status | Beschreibung |
|---------|--------|-------------|
| [[bitcoin-inverse-of-clown-world]] | established | Buch (Svanholm/de Wolf 2024): Bitcoin als mathematischer Kehrwert der «Clown World» (politisierte Fiat-Ökonomie, Nullsummendenken). Legal vs lawful, Anreize (sparen statt ausgeben), «freedom footprint», Aufmerksamkeit als Ressource, technologische Deflation, «we are becoming our money». |
| [[praxeology]] | established | Buch (Svanholm 2023): Einführung in die Praxeologie (Mises' «Logik des Handelns»). A-priori statt Empirie, Handlungsaxiom, Unbehagen→Handlung, Mittel/Zwecke, subjektiver Wert, Zeit/Unsicherheit/freier Wille, Katallaktik (Bastiats «Paris wird gespeist»). |
| [[bitcoin-unabhaengigkeit-neu-gedacht]] | established | Buch (Svanholm 2020): Bitcoin als Souveränitäts-/Freiheitsbuch. Intersubjektive Fiktionen (Steuern/Inflation/Demokratie) auf Gewalt gestützt, «Warum Kollektivisten gewinnen», Matrix-Rote-Pille, 24 Wörter als Superkraft, kann man Bitcoin überhaupt besitzen? |
| [[internet-of-money-vol1]] | established | Buch (Antonopoulos 2016, Vortragssammlung 2013–16): Geld-Entwicklungsstufen, dumb networks/permissionless innovation, Infrastruktur-Inversion, Netzneutralität/Unbanked, Geld als Sprache und als Content-Type, «keine Coins», Skalierung als bewegliches Ziel. |
| [[internet-of-money-vol2]] | established | Buch (Antonopoulos 2017): «Blockchain vs Bullshit», Zweck des Minings ist Sicherheit, hard/soft promises, Währungskriege/war on cash, Bubble Boy vs Kanalratte (security-by-isolation), Streaming Money/Lightning, Löwe & Hai (BTC vs ETH), open-blockchain maximalist. |
| [[internet-of-money-vol3]] | established | Buch (Antonopoulos 2019): «The measure of success is liberty», Libre-not-Libra (fünf Säulen offener Blockchains), Geld als Kontrollsystem (voice & exit), KYC/AML «worse than useless», unstoppable code (can't vs won't), form follows function, «Fork Off». |
| [[origins-of-money]] | established | Buch (Carl Menger 1892): Warum wird ein an sich nutzloses Gut zu Geld? Widerlegung der Gesetzes-/Konventionstheorie, Absatzfähigkeit (saleableness) als spontane Lösung des Tauschproblems, Geld als Institution ohne Planer, Fundament der österreichischen Schule; Bitcoin-Bezug. |
| [[bitcoins-verwahren-und-vererben]] | established | Buch (Marc Steiner 2020, Ratgeber): Nachlassplan für Bitcoin. Non-custodial + cold storage, Werkzeuge (Hardware-Wallet, Seed, Passphrase, Shamir, Multisig, Schließfach), Spannung Zugänglichkeit vs Sicherheit fürs Erbe, Hilfstool. |
| [[das-privacy-handbuch]] | established | Buch (Timo Volkov, Ratgeber): digitale Privatsphäre. Threat Model, digitaler Minimalismus, Fundament (Linux/Tails/GrapheneOS), Werkzeug-Stack (LibreWolf/Tor/VPN/Signal/PGP), OSINT-Abwehr («Plant your flag»), Bitcoin privat nutzen. |
| [[grokking-bitcoin]] | established | Buch (Rosenbaum, dt. «Bitcoin begreifen»): technische Einführung, Schicht für Schicht. Kurzeintrag mit Kapitelübersicht (Hashfunktionen→SegWit) und Verweisen auf die Konzept-Artikel im Wiki. |
| [[mastering-bitcoin]] | established | Buch (Antonopoulos/Harding, 3. Aufl. 2023): technisches Standardwerk auf Implementierungsebene. Kurzeintrag mit Kapitelübersicht (Keys, Transaktionen, Script, Signaturen, Netzwerk, Mining, Lightning) und Konzept-Backlinks. |
| [[einfuehrung-in-das-lightning-netzwerk]] | established | Buch (Antonopoulos/Osuntokun/Pickhardt, dt. Ausgabe von «Mastering the Lightning Network» 2022/2023): technisches Standardwerk zu Lightning. Kurzeintrag mit Kapitelübersicht (17 Kapitel: Zahlungskanäle, Routing, Onion-Routing, Wire-Protokoll) und Konzept-Backlinks. Original frei auf GitHub (lnbook), CC-BY-SA 4.0. |
| [[magic-future-money]] | established | Buch (Hg. Friedemann Brenneis 2022, Aprycot): SciFi-Anthologie zum Geld der Zukunft, 30 prämierte Geschichten aus 290 Wettbewerbsbeiträgen. Geld als Zeit/Energie/Körper/Status, dystopisch bis hoffnungsvoll; belletristische Ergänzung zu den Ökonomie-Büchern. CC BY-NC-ND 4.0. |
...
| [[bitcoin-adoption-report-river-2026]] | emerging | River-Jahresreport 2026: Individuen verkaufen (−696K BTC 2025), Institutionen kaufen; Projektion institutionelle Mehrheit bis 2036; CNB erste Zentralbank mit BTC-Reserve; Lightning +300%; 23 Staaten; BTC = 1,2% des globalen Geldes. |
...
| [[bitcoin-energie-messung-beest]] | established | Daniel Batten: BEEST-Modell (Bottom-up, ~98% Hashrate, inkl. Off-Grid); CCAF überschätzt Verbrauch ≥23,7% und Emissionen >100%; Hydro grösste Quelle (23%); Bitcoin 52,6% höchster nachhaltiger Industrieanteil; 4 ESG-Firsts; emissionsnegativer Anteil 1,3% (netto -5,7%); 23 Bio. ESG-Kapital / 1% = $1,76T MCap; $421M für treibhausgasnegativ |
...
| [[bitcoin-fehlannahmen]] | established | 10 häufige Missverständnisse widerlegt + Ponzi-Widerlegung (Lyn Alden) + Farrington: 6 Gründe warum die Bitcoin-These falsch sein könnte + Parker Lewis: Bitcoin ≠ Schneeballsystem (kein Organisator, kein MLM, fixes Angebot, Konsens-Geldpolitik vs. Fed/Hayek) + Saylor-Konter auf Johnson-Ponzi-Vorwurf (2026) |
| [[bitcoin-volatilitaet-und-preisfindung]] | established | Lewis GTS: Nicht volatil ≠ Wertspeicher; Volatilität = Preisfindungsfunktion; Adoptionswellen; Taleb: Schwankung ist Information. Wankum: Bärenmärkte notwendig; Halving-Zyklen. Neu: Fallstudie stiller Zyklusbruch 2025/26 (leises ATH 126k, Q4-Ausfall, −50%, Erwartungs-Frust) + Nowaks «Der Preis ist wichtig»-These. |
...
| [[bitcoin-humanitaere-anwendungen]] | established | Ukraine + Gaza (humanitäre Zahlungen bei gesperrter Infrastruktur) + Kuba (CUP/CUC/MLC + Lucia + Bitremesas) + Afghanistan (Roya Mahboob, Citadel Software 85% Frauen, Laleh Farzan 2.5 BTC) + Gladstein: $200B-Entwicklungshilfe-Mängel; Virunga-Nationalpark DRC (15MW Wasserkraft + Mining); «Check Your Financial Privilege» (Nigeria/Afghanistan-Porträts); CFA-Franc als monetärer Kolonialismus (15 Staaten, 50% Reserven Paris); Dadaab/Aisha (Batten: M-Pesa-Workaround, 300k Bitcoin-nutzende Flüchtlinge) |
| [[bitcoin-informationstheorie-entropie]] | emerging | Segal: Buckminster Fuller Kilowatt-Dollar (1969); TE=-IE Entropie-Gleichgewichtshypothese; Fiat ME>0, Bitcoin ME=0; Deflation als Produktivitätsmaß; Bitcoin als Spiegel/Kompass; Shannon Informationstheorie. |
...
| [[bitcoin-marktkommentar-lnms]] | established | Hub: Pascal Hüglis Newsletter «Less Noise More Signal» (ehem. Insight DeFi). Makro-/On-Chain-Marktkommentar mit deklariertem Pro-Bitcoin-Bias. Kernrahmen: «Liquidity Corner» (Netto-Finanzliquidität = Fed-Bilanz − RRP − TGA), «QE ist ein Lock», «Bad news is good news», LTH-Euphoriephase, ETF/MSTR-Beobachtung. Interview-Podcast mit Makro-/Trading-Gästen. Wächst über die LNMS-Compile-Etappen. |
| [[bitcoin-menschenrechte]] | established | Herbort: 30 UN-Artikel ohne Geld-Begriff — aber Geld taktiert fast alle. Nawalny, Uiguren, Sotoudeh als Beispiele. Cantillon-Effekt. 2,2 Mrd. Unbanked. Hypothetischer Artikel 31: Recht auf gesunde Währung. Ferdinand Bloch-Bauer. |
| [[bitcoin-monetarisierung]] | established | Boyapati: 4 Monetarisierungsphasen; Malki: Weltreservewährungs-Szenario, S-Kurve; Szabo Geldursprung; Bitcoin vs. Gold; Österreichische Konjunkturtheorie. Neu: Gold-Rally 2025 (+64%) als Wegbereiter; umgekehrte Adoptionsreihenfolge 2024–26 (Institutionen vor Retail). |
...
| [[bitcoin-als-strategische-reserve]] | emerging | Bitcoin als Staatsfonds-Asset: El Salvador/Bhutan/USA-Precedenz; Best Practices Custody/Governance; kontrafaktische RDF-Analyse 2018–2024 (3%+ BTC schützt real gegen Inflation); Timing-Risiken; Seetee/Aker: 500 Mio. NOK (Røkke 2021), Mining als ökonomische Batterie, Blockstream-Partnerschaft; Iran/Hormus 2026 (2 Sekundärquellen, Umsetzung offen) |
| [[bitcoin-powerlaw-und-preismodelle]] | established | Power Law (β=5.69, mechanistisch); Rudd & Porter (JRFM 2025): 50% >5,17 Mio. USD bis 2036; Liquid Supply als Hebel. Neu: Perrenods log-periodisches Zyklusmodell (Peak-These 2027), Ende des 4-Jahres-Zyklus 2025, Praxis-Check unteres Band 2026 |
| [[blocksize-war]] | established | Der Blocksize-Krieg 2015–2017: Big-Blocker vs. Small-Blocker; Bitcoin XT → Classic → Unlimited → BTC1/SegWit2x; UASF, NYA, BIP 91; SegWit-Aktivierung Aug 2017; Bitcoin Cash; Small-Blocker-Sieg Nov 2017; BIP-110/Spam-Debatte und mögliche Rückkehr der Blockgrössen-Frage (2026) |
| [[bitcoin-mining-dezentralisierung]] | established | Schmid: Transaktionszensur-Risiko durch Mining-Konzentration; US-Hashrate 35%; Stratum V2 Job Selection; "Not your miner, not your block"; ASIC-als-Heizung; Solar-Überschuss-Mining; Lotto-Mining (NerdAxe) als Einstiegsstufe |
| [[bitcoin-mining-energiequellen]] | established | Mining-Energiequellen und -Anwendungen: Solar/Wind/Geothermie/Methan/Bioraffinerien/Green Hydrogen; Curtailment-Monetarisierung; Investitionsanreiz für Erneuerbare; Abwärme/District Heating (Finnland 2%); Wasserverbrauch; Methanminderung GWP20 (bis 5,3% global) |
| [[bitcoin-mining-netz-und-oekonomie]] | established | Mining und Stromnetz: Demand Response (500ms-Abschaltung), Texas/ERCOT $18Mrd. Einsparung, Norwegen +20%, Preiseffekte; Mini-Grids (Virunga, Costa Rica, Sub-Sahara) als Elektrifizierungs-Initialzündung; Captain Sidd (perfekter Wettbewerb), Agile Energy X (Tateiwa), Parker Lewis (Geld als Koordination) |
| [[bitcoin-mining-narrativ-und-kritik]] | established | Mining-Narrativwandel seit 2021: 80%+ peer-reviewed Papers positiv; de Vries' Methodenfehler (per-Transaktion, eWaste +1204%); Sai & Vranken Methodik-Review; Greenpeace-Rückzug; NGOs/Gas-Flaring/Greenwash; Gas-Peaker; ESMA, ESG-Chasm; Medien-Lackmustest; Skull of Satoshi |
| [[greenpeace-vs-bitcoin]] | established | Greenpeace USA gegen Bitcoin: «Change the Code»-Kampagne (2022, $5M Chris Larsen/Ripple), «Skull of Satoshi» (Von Wongs Seitenwechsel), «Bankrolling Bitcoin Pollution»-Report (2024) und Battens 3-Punkte-Rebuttal (Obviation-Effekt, de Vries=Zentralbank); Anti-Nuklear-Parallele; stiller Rückzug bis 2025; Greenpeace International ohne Endorsement |
...
| [[bitcoin-einsteiger-onboarding]] | established | Michael Wolf «Bitcoin-Ratgeber»: Fünf-Schritte-Umzug Börse → eigene Wallet, Testbetrag als Grundregel, Custodial vs. Non-Custodial, Einsteiger-Wallets (Aqua/Sparrow/BitBox02), erste Satoshis. |
| [[bitcoin-auf-kredit]] | established | Nowak: Konsumentenkredit vs. Sparplan, Rückrechnung 2013–2021 (Kredit meist im Vorteil, außer nahe ATHs); Laufzeiteffekt senkt Timing-Risiko; Power-Law-Timing; Psychologie als Hauptrisiko; Recht/Ethik; Normalisierung 2023→2025 |
| [[bitcoin-beratung-und-micar]] | emerging | MiCAR-Stichtag 1.7.2026: 118 CASPs (>80% Marktbereinigung, Binance-Aus); Beratungslücke: nur 24/202 mit Advice-Lizenz, sechs DACH-Häuser (Coinfinity, Bankhaus Scheich u.a.), keine Universalbank; Execution-only-Dominanz; Art. 60-Notifikation für Banken, Art. 79 Eignungsbericht, Art. 81(9) Pflichthinweise; Schweiz/Liechtenstein/Südtirol; Praxisfall DIS/VR-Bank Bayern Mitte (80% Volumen Ü40, seit 4/2026 Custodial-Default) |
| [[bitcoin-besicherte-kredite]] | established | Nowak: BTC als Pfand, LTV als Kernkennzahl (Firefish-Stufen 73/79/86/95%); Custody vs. Escrow; Buy-Borrow-Die mit 2 Rechenbeispielen (nur Zuwachs entnehmbar; 50k€ p.a. braucht >1,6M€ Collateral); «Überleben ≠ davon leben»; 5 Risiken; Volksbank-Produkt |
| [[bitcoin-kommunikation-und-orange-pilling]] | established | Batten: 7 Orange-Pilling-Prinzipien, Sector Ambassadors, Perception-Daten. Neu: DACH-Praxisbefunde (Nowak) — Rechthaben vs. Verstehen, Referenzpunkt-These, Grenzfragen (moralische Pflicht, Familienfrieden, Kritiker-Geduld), Beweislastumkehr bei Medienkritik. |
| [[bitcoin-konferenzen-und-community]] | established | Szabelski: Vier-Phasen-Modell; Konferenzjahr 2025 (Prag 7–8k, Ingolstadt 3k+). Neu: Zitadellen als nichtkommerzielles Gegenmodell (Heldrungen 600, Obonjan 500), Volksbank als Ingolstadt-Veranstalter, Bärenmarkt-Stimmung Prag 2026, Brafe-Befund (Geld leises Thema außerhalb der Bubble). |
| [[frauen-und-bitcoin]] | established | Nowak: Gender-Gap als Gleichstellungsproblem; Les Femmes Orange (Telegram 1.000+, Weltfrauentag München, Livestreams); anfänglicher Community-Widerstand, heute Zubringer-Effekt; Geld-Glaubenssätze und Scham als Erklärungsansatz; Formate, die Frauen erreichen. |
...
| [[bitcoin-whitepaper-errata]] | established | Harding-Errata (CC0): 4 widerlegte Annahmen (Finney-Attacke, Selfish Mining ~30%, Merkle-Pruning, SPV-Alerts), stille Code-Korrekturen (most-work chain 2010, Difficulty), präzisierte Konzepte (DAG of encumbrances, one-CPU-one-vote, Nodes≠Miner); Selbstkritik als Stärke. |
...
| [[bitcoin-treasury-companies]] | emerging | Marktübersicht/Snapshot 2026-07-17 (bitcointreasuries.net): 197 Public Companies halten 1'263'286 BTC (~$81 Mrd., 6.0% von 21M); Strategy allein 843'775 BTC (4.018%); mNAV/Cost-Basis/NgU zeigen Sektor unter Wasser (MSTR NgU 0.85x, mNAV 1.017); vier Haltertypen; Zeitreihen-Anker |
...
| [[der-bitcoin-standard]] | established | Buch (Saifedean Ammous 2018): Bitcoin als erstes digitales hartes Geld und Nachfolger des Goldes; Geldgeschichte als Wettbewerb um Härte; fixes Angebot = härtestes je erfundenes Geld |
| [[der-fiat-standard]] | established | Buch (Saifedean Ammous 2022): Fiat als Technologie — Schulden werden zu Geld, Geld per Kreditvergabe «geschürft»; Folgen bis Ernährung/Wissenschaft/Familie; Bitcoin als «Fiat-Liquidator» |
| [[gesetze-der-wirtschaft]] | established | Buch (Saifedean Ammous 2023, «Principles of Economics»): systematisches Lehrbuch der österreichischen Ökonomik, von der Einzelhandlung über Kapital und Energie bis Geld und monetärer Expansion |
| [[the-bitcoin-handbook]] | established | Buch (Anil Patel 2023): visuelle Enzyklopädie von ~58 mentalen Modellen zu Bitcoin, je Schaubild + Kurztext; Nachschlagewerk, gratis online |
| [[goldene-zukunft]] | established | Buch (Florian Bruce-Boye 2024): deutschsprachiges Einsteigerbuch; was Geld ist und warum es an Wert verliert, Bitcoin als Wertspeicher neben Gold, Aktien, Immobilien |
| [[das-buch-satoshis]] | established | Buch (Phil Champagne, «The Book of Satoshi»): chronologische Sammlung von Satoshis öffentlichen Schriften 2008–2011 (Mailinglisten, Foren, E-Mails) mit Einordnungen des Herausgebers |
| [[das-kleine-bitcoin-buch]] | established | Buch (The Bitcoin Collective 2019, dt. Aprycot 2021): Einsteiger-Primer ohne Technik; kaputtes Geld (Inflation, Single Point of Failure, Ende der Privatsphäre), Bitcoin als dezentrale digitale Knappheit, Fokus Menschenrechte; zwei Zukunftsvisionen 2039 |
| [[das-trojanische-pferd-der-freiheit]] | established | Buch (Alex Gladstein 2023, Original «Check Your Financial Privilege»): Reportagen aus Nigeria/Sudan/Äthiopien/El Salvador/Togo/Palästina/Kuba; finanzielles Privileg, NGU+FGU, Bitcoin als Trojanisches Pferd der Freiheit |
| [[hidden-repression_how-the-imf-and-world-bank-sell-exploitation-as-development]] | established | Buch (Gladstein/Nabourema/Booth 2024): IWF & Weltbank-Strukturanpassung als neokoloniale Ausbeutung (Bangladesch-Shrimp, Bedingungskatalog, Schuldenfalle, CFA-Franc); Bitcoin als Währung der Dekolonisierung, Africa Bitcoin Conference |
| [[bitcoin-development-philosophy]] | established | Buch (Kalle & Linnea Rosenbaum 2024, Konsensus, CC BY 4.0): die Werte, nach denen Bitcoin entwickelt wird — Dezentralisierung, Vertrauenslosigkeit, Privatsphäre, Fungibilität, festes Angebot; erklärt Bitcoins vorsichtigen Änderungsprozess |
| [[bitcoin-geldpolitik-und-21-millionen-limit]] | established | Wie das 21-Mio-Limit durch Code und dezentrale Nodes durchgesetzt wird; Meilenstein 20-millionster BTC (Block 940.000, März 2026), liegengelassene Blockbelohnungen |
| [[bitcoin-haltefrist-und-steuern]] | established | Ein-Jahres-Haltefrist (§ 23 EStG, BFH 2023: Wirtschaftsgut) vs. Österreich (27,5% seit 2022, nur 34 Mio. Einnahmen 2024); Abschaffungsdebatte 2026: Klingbeil/Haushaltseckwerte 2027, Verfassungsrisiken (Folgerichtigkeit, 3 Optionen), Blockpit/Divly-Datenkritik (Kühnert 10 Mrd. vs. Klingbeil 2 Mrd.), DAC8; Bundestagspetition prohaltefrist.de (Bitcoin Bundesverband); Buy-Borrow-Die-Anschluss |
...
| [[dollar-hegemonie-super-imperialismus]] | established | Gladstein/Hudson: Aufstieg des Treasury Bill Standard; Bretton Woods; Nixon-Schock 1971; Petrodollar-Pakt 1974 (Kissinger/Saudi + versteckte Kosten: Diktaturen, Kriege, Ungleichheit, Klimaanreize); IWF/Weltbank als Instrumente; De-Dollarisierung; Bitcoin als besseres Gold |
...
| [[praxeologie-methode-und-werttheorie]] | established | Praxeologie als A-priori-Wissenschaft; Ökonometrie-Kritik; Handlungs-Axiom; subjektive Wertlehre/Grenznutzen; Zeitpräferenz; Katallaktik; Profit als praxeologischer Begriff; Argumentationsethik/NAP; Bitcoin als konsistentes Geld; Svanholms fünf Bücher; Mattes' Drei-Schichten-Modell |
| [[oesterreichische-kapital-und-geldtheorie]] | established | Cantillon-Effekt; Spar-Kaskade (Kapitalaufbau durch niedrige Zeitpräferenz); Besitz vs. Eigentum (Mises/Wankum); Kapital als Werkzeuge (Farrington/de Soto/Kirzner); Mises als Bitcoin-Maximalist (Goldstein, Regressions-Theorem); gutes/schlechtes Geld (Taghizadegan) |
| [[zitate]] | living | Markante Zitate zu Bitcoin von Primärquellen; Lyn Alden über Bitcoins Wert ("store and transfer debasement-resistant value globally without centralized permission") |
...
| [[onchain-indikatoren-und-anlegerverhalten]] | established | Wüstenfeld (BMI 2023 + SSRN-Paper mit Geldner/Beckmann): Erholung 2023 von Stackern statt neuen Nutzern (Adressen/Tx hoch, Transfervolumen flach, LTH ~67% ATH); Working Paper: Kleinanleger prozyklisch auf Sentiment/Medien, Großanleger schwächer/gegenläufig; Blockchain als Forschungsdatenquelle. |
| [[mvrv-und-realized-cap]] | established | Coin Metrics (2018), Mahmudov/Puell (2018) + Wüstenfeld-Dashboard: Realized Cap bewertet UTXOs zum Kurs der letzten Bewegung (aggregierte Kostenbasis; Le Calvez/Carter, ~15% Supply verloren); MVRV = Market/Realized Value, historisch >3,7 Top-, <1,0 Bodenzone; MVRV-z als rollierender leak-free z-Score; Grenzen (Cold Storage vs. verloren, ETF-Custody). |
...
| [[phishing-und-angriffsmethoden]] | established | Fake-Apps, Address Spoofing, Phishing-E-Mails, Keylogger — Angriffsmethoden und Gegenmaßnahmen; Rendite-/Mining-Scams (Social Media 2025, Optioment-Referenz) |
| [[regulierung-tofr-aopp]] | established | EU ToFR / Travel Rule; Satoshi-Test-Probleme; AOPP als bessere Adressverifizierung |
| [[schuldenzyklen]] | established | Szabelski nach Dalio: langer Schuldenzyklus seit 1945, kurzfristige Zyklen 6–9 Jahre; Schuldenwanderung Privatsektor → Regierung → Fed (245 Mrd. Defizit 2026); vier Geldphasen (1945/1971/2008/2020); Reservewährungen enden durch Krieg oder Schuldenberge. |
...
| [[skalierung-lightning-ark-statechains]] | emerging | Lightning (Kuriere), Ark (Zug mit VTXOs), Statechains (Eigentum übertragen ohne Bewegung); Cube: BitVM + Timeout Trees + Bitcoin DA → Turing-complete VM mit unilateralem Exit, kein Bridge-Operator |
...
| [[shamir-secret-sharing]] | established | k-of-n Geheimnis-Aufteilung via Polynom-Mathematik; warum 1 Share nichts verrät; Unterschied zu Multisig; FROST als Weiterentwicklung ohne Rekonstruktions-Risiko; SLIP-39 als Bitcoin-Anwendung; Poor Man's Shamir + Schließfach-Versicherungslücke |
...
| [[stablecoins-und-agentische-zahlungen]] | emerging | Stripe Sessions 2026: Stablecoin-Stack aus Bridge/Privy/Tempo, Streaming-Micropayments für KI-Agenten (MPP), Link hält Stablecoins (250 Mio. Nutzer), Treasury-Rails in 100→160 Ländern; Einordnung vs. Lightning und Fiat-Kontrollrisiken; Q2/2026: Visa/Mastercard/Stripe-Konsortium (BVNK/Bridge-Zukäufe, Circle-Bedrohung), AllUnity EURAU/CHFAU, Qivalis (37 Banken). |
...
| [[bitcoin-als-organismus]] | established | Quittem: Bitcoin als dezentrales Pilznetzwerk; Tokyo-Experiment; PoW = gestrandete Energie; Hype-Zyklen wie Pilz-Fruchtkörper; BCH-Fork als Schisma; antifragil gegen Angriffe (8 Überlebensfaktoren); Satoshi-Cypherpunk-Symbiose analog Pilz-Pflanzen vor 500 Mio. Jahren; Perrenod: Autopoiese; Imago-Zellen-Analogie (Kipppunkt der Adoption) |
| [[bitcoin-bildung]] | established | Mi Primer Bitcoin/Bitcoin-Diplom; Coinfinity+Scholarium+Aprycot; Kinderbuch/Hörbuch/Lesestunde; Fiatscham. Neu: Bitcoin im deutschen Schulunterricht (Fall Bingen/Spath), Senioren-Schulungen («Versilberer»), VHS-Kurse, Einsteiger-Podcast als Massenformat (64k Streams). |
| [[bitcoin-etf-und-institutionelle-verwahrung]] | established | Farrington: 1933er-Trust (kein Rücknahmerecht) vs. 1940er-ETF (GBTC-Diskont); 8 Prognosen zum BlackRock-ETF; Coinbase als einziger Authorized Participant = Chokepoint; JPMorgan Cascade; Gold-Paradox auf Bitcoin; institutionelle Custody als ungelöstes Problem; Fedi/OP_VAULT/Unchained/AnchorWatch als Ansätze; Europa 2026: ETPs (ETN/ETC-Schuldverschreibungen), Wallet-oder-Depot, Re-Intermediation, Morgan-Stanley-Spot-ETF |
...
| [[geld-staat-und-fiat-monopol]] | established | Hoppe: Staatliche Motivation zur Geldmonopolisierung; Keynes 1919: Inflation als willkürliche Enteignung; IWF/Weltbank als Fiat-Transmissionsriemen (Gladstein); globaler Cantillon-Effekt; Bitcoin als technische Lösung; Precht/Fab 2026: staatsfreies Geld als Demokratie-Leitplanke |
...
| [[globale-liquiditaet-und-finanzplumbing]] | emerging | LNMS/Hügli: Liquidität als dominanter Bitcoin-Preistreiber. US-Netto-Liquidität (Fed − RRP − TGA), SLR/Bankreserven, Global-M2-Kritik (Consorti), Liquiditätszyklus/Maturity Wall/Stealth QE (Howell), Repo-Markt/Primary Dealers (Lighthouse), GENIUS-Act-Stablecoins und Kreditwachstum, Kapitalkontrollen (Gromen), «Four F's» (Kizemchuk), Bitcoin als Liquiditäts-Barometer und dessen Grenze. |
| [[glossar-allgemein]] | established | Nachschlage-Glossar allgemeine Begriffe: Geld/Ökonomie, Markt, Adoption, Verwahrung als Praxis, Akteure, Einheiten (Altcoin, HODL, DCA, KYC, Fiat, Whale, Stablecoin, mNAV, Cost Basis, NgU, MSTR …); englische Fachbegriffe erhalten, Konzeptartikel verlinkt. Quellen: House of Satoshi, aantonop, Mastering Bitcoin, Bitcoin Design |
| [[glossar-bitcoin-technik]] | established | Nachschlage-Glossar Bitcoin-Protokoll (Basisschicht): Transaktionen, Blöcke, Schlüssel/Adressen, Script, Konsens, Mining-Mechanik (UTXO, SegWit, Taproot, Merkle Tree, PSBT, Schnorr …). Quellen: Mastering Bitcoin, aantonop, Bitcoin Design, lnbook |
| [[glossar-lightning]] | established | Nachschlage-Glossar Lightning: Kanäle, Routing, Liquidität, Sicherheitsmechanik (HTLC, Commitment/Funding-Tx, Onion Routing, MPP, Watchtower, Submarine Swap …); Ethereum raus, Produkt-Tools weggelassen. Quellen: Lightning Labs, lnbook, aantonop, Bitcoin Design |
...
| [[neofeudalism-und-bitcoin-exit]] | established | Farrington Bitgenstein IX–X: Kotkins Neo-Feudalismus; Bitcoin als Ariadnefaden; McNeill: mobiles Kapital; Verbote = Scheitern; Svetski: Orwell+Huxley gleichzeitig (Überwachung+Vergnügen), CBDCs als programmierbare Kontrolle, Bitcoin als technische Tatsache |
...
| [[bitcoin-ist-die-wiederentdeckung-des-geldes]] | established | Gigi-Essay (2022): Geld per Negation (keine Rendite, kein Gegenparteirisiko, keine Identität, kein Gedächtnis); Bitcoin als Naturgewalt mit fixer Geldpolitik; moralisches Argument gegen Fiat und «Krypto»; Wiederentdeckung nur über eigene Schlüssel + eigenen Node |
...
| [[bitcoin-und-selbstverantwortung]] | established | Gigi: "Bitcoin bringt das in Ordnung" — aber nicht magisch; Kanada 2022 (Truckerprotest, Konten eingefroren); "Du bist das Netzwerk"; partizipatives Wissen; Skin-in-the-Game (Verantwortung, Bitcoin anzunehmen); drei Pfeiler (Wahrheit/Liebe/Verantwortung); Cicero-Vorbereitung; Morpheus-Zitat. |
| [[hyperbitcoinization-und-zitadellen]] | emerging | Warren 2089: hypothetische Transition zur Bitcoin-Weltreservewährung; 3 Zitadellen-Typen (digital/territorial/souverän); De-Dollarisierung, Boomer-Vermögenstransfer, globaler Süden als frühe Adopter. |
...
| [[bitcoin-und-ki]] | emerging | Wankum TBN #28: Bitcoin und KI beide deflationar. KI senkt Grenzkosten der Produktion; Bitcoin fixiert Geldangebot. KI-Agenten brauchen Geld — Bitcoin ist das einzige Geld, das Maschinen selbst verwahren können. Micropayments per Lightning. Visser 2026: KI zerreißt Arbeit-Geld-Deal, Bitcoin wird Notwendigkeit; Lightning-Labs-Toolkit für KI-Agenten-Zahlungen. |
| [[bitcoin-und-psychologie]] | emerging | Quittem: Myers-Briggs-Überrepräsentation (INTJ); Milgram-85/15-Deutung (Nonkonformisten); False Uniqueness Bias als Gegenkorrektiv; Michigan-State-Paper «Most Trustworthy Coin» + trustless-Replik (Vertrauen durch Verifikation). |
