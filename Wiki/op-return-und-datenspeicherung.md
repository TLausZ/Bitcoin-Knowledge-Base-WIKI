...
Die Idee, beliebige Daten auf der Bitcoin-Blockchain zu speichern, ist so alt wie das Netzwerk. Satoshi Nakamoto selbst hinterliess im Genesis-Block die Nachricht *„The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"*.
...
- **Ordinals/Inscriptions:** Speichert grosse Datenmengen im Witness-Teil von SegWit-Transaktionen
...
OP_RETURN ist einer der einfachsten Skriptbefehle. Eine Node, die auf einen OP_RETURN Output stösst, markiert ihn sofort als ungültig und macht weiter.
...
Bitcoin Core setzt standardmässig ein Limit von 80 Bytes für Daten in OP_RETURN Outputs durch. Das ist eine **Mempool-Richtlinie**, keine Konsensregel.

Das Limit verhindert nicht wirklich das Speichern grösserer Datenmengen: Ein einziger Miner kann Transaktionen mit grösseren OP_RETURN Outputs direkt in Blöcke aufnehmen. Und für wirklich grosse Datenmengen werden sowieso alternative Methoden (Inscriptions) verwendet.
